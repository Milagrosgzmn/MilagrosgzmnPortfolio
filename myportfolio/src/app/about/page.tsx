    ...
    return(
        <section className="py-20 max-w-[62rem] w-4/5 mx-auto mb-10">
            ...
            <article className="flex justify-between items-center mx-auto  w-4/5">
                ...
                <p>Estoy aprendiendo estas tecnologías de forma autodidacta y espero próximamente poder sumar proyectos empleándolas.</p>
                <div className="flex">
                    <div className="flex flex-col justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="w-24 h-24" viewBox="0 0 48 48">
